/**
 * Array of all available HeroIcon names (kebab-case)
 * Derived from @heroicons/vue/24/outline exports
 * e.g., "check-circle", "home", "bars-2", etc.
 * This is the single source of truth for icon names.
 */
...
/**
 * Type representing all valid HeroIcon names
 * Derived from the heroIconNames array
 */
