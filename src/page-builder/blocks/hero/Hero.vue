<template>
   <section id="hero-section">
      <section class="lg:grid lg:place-content-center" :class="isDarkMode ? 'bg-gray-900' : 'bg-white'">
         <div class="mx-auto flex w-full max-w-7xl items-center px-4 py-16 sm:px-6 sm:py-24 lg:px-8 lg:py-24">
            <div
            ...
            >
               ...
               >
                  <a
                     ...
                     :class="
                        cta.style === 'solid'
                           ? 'border-red-600 bg-indigo-600 text-white hover:bg-indigo-700'
                           : isDarkMode
