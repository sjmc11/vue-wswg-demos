<template>
    <div class="mx-auto max-w-5xl px-4 py-8 sm:px-6 lg:px-8">
      <div v-if="heading || description" class="mb-5 md:mb-9 max-w-prose" :class="{
      ...
      <div v-if="showViewAllLink && !articlesLoading && !articlesError" class="mt-4 md:mt-9" :class="{
        'text-center': textAlign === 'center',
        'text-left': textAlign === 'left',
        'text-right': textAlign === 'right',
      }">
        <a href="#" class="py-2 px-4 bg-zinc-900 text-white rounded-md mx-auto inline-block hover:bg-zinc-800 transition-colors">View all articles</a>
      </div>
    </div>
  </template>
