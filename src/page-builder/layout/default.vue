<template>
   <main class="default-page-layout">
      <div id="app-header" class="border-b border-gray-300">
         <div class="max-w-5xl mx-auto flex items-center px-5 py-7 justify-between">
            <img src="../../assets/logo.png" alt="branding" class="w-36 h-auto" />
            <nav>
               <ul class="inline-flex items-center gap-2">
                  <li>
                     <a href="#" class="text-white bg-indigo-700 rounded-full px-4 py-2">Home</a>
                  </li>
                  <li>
                     <a href="#" class="text-gray-600 hover:bg-gray-100 rounded-full px-4 py-2">About us</a>
                  </li>
                  <li>
                     <a href="#" class="text-gray-600 hover:bg-gray-100 rounded-full px-4 py-2">Our team</a>
                  </li>
                  <li>
                     <a href="#" class="text-gray-600 hover:bg-gray-100 rounded-full px-4 py-2">Get in touch</a>
                  </li>
               </ul>
            </nav>
         </div>
      ...
      <footer class="bg-gray-100">
         <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
            <div class="flex justify-center text-teal-600 mb-6">
               <img src="../../assets/logo.png" alt="branding" class="w-30 h-auto" />
            </div>
