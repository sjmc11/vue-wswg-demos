<template>
   <header id="app-header" class="sticky top-0 z-20 border-b border-gray-300 bg-white">
      <div class="page-container @3xl:py-5 @3xl:h-auto z-20 flex h-20 items-center justify-between py-4">
         ...
         <nav
            class="@3xl:block w-2xs @3xl:size-auto @3xl:border-none @3xl:bg-transparent @3xl:relative @3xl:p-0 @3xl:top-0 absolute right-0 top-20 z-50 h-[calc(100vh-78px)] border-l border-t border-gray-300 bg-white p-7"
